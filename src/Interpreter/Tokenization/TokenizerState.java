...
public enum TokenizerState {
    ...
    INTERGER, // We enter this state after a digit. From here we can either build an integer,
              // build a float, or return to start.

    FLOAT, // We enter this state after seeing a '.' from the integer state or a digit from
           // the decimal state. From here we can either build an float, or return to
           // start.
